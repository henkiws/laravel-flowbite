<x-app-layout>
    ...
    <div class="flex justify-between mb-3">
        <h5 class="text-xl font-bold dark:text-white">Bank</h5>
        <x-breadcrumbs :bcLinks="['Master']" bcActive='Bank'></x-breadcrumbs>
    </div>
    ...
    <div class="w-full p-4 text-center bg-white border border-gray-100 rounded-lg sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="mt-2 text-right">
            <x-button :btnType="'button'" :btnClass="'btn-add-new'" :btnOpenModal="'modalBank'" :btnName="'Add New Bank'" :btnIcon="'add'" :btnStyle="'dark'" :btnAttrs="['data-action' => route('banks.store')]"> </x-button>
        </div>

        <x-table :tableHeader="[ 'No', 'Bank Name', 'Description', 'Image', 'Active', 'Date Creation', 'Action' ]" :tableData="$banks" :tableElement="['no','name','description','image','active','created_at','action']" :tableAction="'banks'" tableModalId="modalBank"></x-table>

    </div>

    <x-modal :modalId="'modalBank'" :modalFormAction="'banks.store'" :modalTitle="'Bank'" modalContent='
    ...
    <x-modal-confirmation :modalId="'modalBankConfirmation'" modalContent='
