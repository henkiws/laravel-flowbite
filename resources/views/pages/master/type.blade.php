<x-app-layout>
    ...
    <div class="flex justify-between mb-3">
        <h5 class="text-xl font-bold dark:text-white">Type</h5>
        <x-breadcrumbs :bcLinks="['Master']" bcActive='Type'></x-breadcrumbs>
    </div>
    ...
    <div class="w-full p-4 text-center bg-white border border-gray-100 rounded-lg sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="mt-2 text-right">
            <x-button :btnType="'button'" :btnClass="'btn-add-new'" :btnOpenModal="'modalType'" :btnName="'Add New Type'" :btnIcon="'add'" :btnStyle="'dark'" :btnAttrs="['data-action' => route('types.store')]"> </x-button>
        </div>

        <x-table :tableHeader="[ 'No', 'Type Name', 'Description', 'Image', 'Active', 'Date Creation', 'Action' ]" :tableData="$types" :tableElement="['no','name','description','image','active','created_at','action']" :tableAction="'types'" tableModalId="modalType"></x-table>

    </div>

    <x-modal :modalId="'modalType'" :modalFormAction="'types.store'" :modalTitle="'Type'" modalContent='
    ...
    <x-modal-confirmation :modalId="'modalTypeConfirmation'" modalContent='
