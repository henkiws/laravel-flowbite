<x-app-layout>
    ...
    <div class="flex justify-between mb-3">
        <h5 class="text-xl font-bold dark:text-white">Music</h5>
        <x-breadcrumbs :bcLinks="['Master']" bcActive='Music'></x-breadcrumbs>
    </div>
    ...
    <x-modal :modalId="'modalMusic'" :modalFormAction="'musics.store'" :modalTitle="'Music'" modalContent='
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                            <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Music Name" required="">
                        </div>
                        <div class="col-span-2">
    ...
    <x-modal-confirmation :modalId="'modalMusicConfirmation'" modalContent='
