<x-app-layout>
    ...
    <div class="w-full p-4 text-center bg-white border border-gray-100 rounded-lg sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <x-nav :navs="[ 'user.index'=>'Users', 'role.index'=>'Roles', 'permission.index'=>'Permissions' ]" :activeTab="'Permissions'"></x-nav>

        <div class="mt-2 text-right">
            <x-button :btnType="'button'" :btnName="'Add New'" :btnIcon="'add'" :btnStyle="'dark'"> </x-button>
        </div>

        <x-table :tableHeader="[ 'No', 'Permission Name', 'Date Creation', 'Action' ]" :tableData="$permissions" :tableElement="['no','name','created_at','action']"></x-table>
